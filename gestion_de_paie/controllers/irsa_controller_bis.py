...
class ExportReportIrsaController(http.Controller):
    ...
    def body(self, workbook, worksheet, payslips, total):
        ...
        worksheet.merge_range('D16:D17', u'N° CNaPS', border_black_center)
        worksheet.merge_range('E16:E17', u'Tps de travail', border_black_center)
        worksheet.merge_range('F16:F17', u'Salaire de base', border_black_center)
        worksheet.merge_range('G16:G17', u'Primes & gratification', border_black_center)
        worksheet.merge_range('H16:H17', u'Heures supplémentaire', border_black_center)
        worksheet.merge_range('I16:I17', u'Congés', border_black_center)
        worksheet.merge_range('J16:J17', u'Préavis', border_black_center)
        worksheet.merge_range('K16:K17', u'Salaire brut', border_black_center)
        worksheet.merge_range('L16:M16', u'Cotisations', border_black_center)
        worksheet.write(16, 11, u'CNaPS', border_black_center)
        worksheet.write(16, 12, u'OSTIE', border_black_center)
        worksheet.merge_range('N16:N17', u'Salaire Net', border_black_center)
        worksheet.merge_range('O16:O17', u'Montant imposable', border_black_center)
        worksheet.merge_range('P16:P17', u'Impôts corresp.', border_black_center)
        worksheet.merge_range('Q16:Q17', u'Déduction enfant', border_black_center)
        worksheet.merge_range('R16:R17', u'Impôts nets', border_black_center)
